...
exports.initialData = {
    users: [
        ...
        },
        {
            ...
            password: bcrypt.hashSync('User789', 10),
            fullName: 'User Three',
            userName: 'user3',
            isActive: true,
            roles: ['user'],
        ...
        },
        {
            ...
            password: bcrypt.hashSync('User101', 10),
            fullName: 'User Four',
            userName: 'user4',
            isActive: true,
            roles: ['user'],
        ...
        },
        {
            ...
            password: bcrypt.hashSync('User202', 10),
            fullName: 'User Five',
            userName: 'user5',
            isActive: true,
            roles: ['user'],
        ...
        },
        {
            ...
            password: bcrypt.hashSync('User303', 10),
            fullName: 'User Six',
            userName: 'user6',
            isActive: true,
            roles: ['user'],
        ...
        },
        {
            ...
            password: bcrypt.hashSync('User404', 10),
            fullName: 'User Seven',
            userName: 'user7',
            isActive: true,
            roles: ['user'],
    ...
    products: [
        {
            description: 'Embark on an intergalactic journey with the Tesla Space Explorer Tee. Made from soft Peruvian cotton, this tee features a futuristic space design and Tesla logo, perfect for young space enthusiasts.',
        ...
        {
            description: 'Let your little one race in style with the Tesla Youth Racing Cap. This cap features a cool racing design, breathable fabric, and an adjustable strap for a comfortable fit.',
