...
export const initialData: SeedData = {
  users: [
    {
      ...
      password: bcrypt.hashSync('Admin123', 10), // Encriptado directamente a la contraseña
      fullName: 'Admin One',
      userName: 'admin1',
      isActive: true,
      roles: ['admin'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('Admin456', 10), // Encriptado directamente a la contraseña
      fullName: 'Admin Two',
      userName: 'admin2',
      isActive: true,
      roles: ['admin'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User123', 10), // Encriptado directamente a la contraseña
      fullName: 'User One',
      userName: 'user1',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User456', 10), // Encriptado directamente a la contraseña
      fullName: 'User Two',
      userName: 'user2',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User789', 10), // Encriptado directamente a la contraseña
      fullName: 'User Three',
      userName: 'user3',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User101', 10), // Encriptado directamente a la contraseña
      fullName: 'User Four',
      userName: 'user4',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User202', 10), // Encriptado directamente a la contraseña
      fullName: 'User Five',
      userName: 'user5',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User303', 10), // Encriptado directamente a la contraseña
      fullName: 'User Six',
      userName: 'user6',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      password: bcrypt.hashSync('User404', 10), // Encriptado directamente a la contraseña
      fullName: 'User Seven',
      userName: 'user7',
      isActive: true,
      roles: ['user'],
    ...
    },
    {
      ...
      userName: 'test1',
      fullName: 'Test One',
      password: bcrypt.hashSync('Abc123', 10), // Encriptado directamente a la contraseña
      roles: ['admin'],
      isActive: true,
      address: '123 Test St',
      phone: '111-222-3333',
  ...
  products: [
    ...
    {
      description:
        'Embark on an intergalactic journey with the Tesla Space Explorer Tee. Made from soft Peruvian cotton, this tee features a futuristic space design and Tesla logo, perfect for young space enthusiasts.',
      images: ['new_space_tee_0.jpg', 'new_space_tee_1.jpg'],
      stock: 20,
      price: 25,
      sizes: ['XS', 'S', 'M', 'L'],
      slug: 'tesla_space_explorer_tee',
      type: 'shirts',
      tags: ['shirt'],
      title: 'Tesla Space Explorer Tee',
      gender: 'kid',
    },
    {
      description:
        'Let your little one race in style with the Tesla Youth Racing Cap. This cap features a cool racing design, breathable fabric, and an adjustable strap for a comfortable fit.',
      images: ['racing_cap_0.jpg', 'racing_cap_1.jpg'],
      stock: 30,
      price: 20,
      sizes: ['XS', 'S', 'M'],
      slug: 'tesla_youth_racing_cap',
      type: 'hats',
      tags: ['hat'],
      title: 'Tesla Youth Racing Cap',
      gender: 'kid',
    },
